...
public static function actividades(): void
{
    try {
        ...
        $pacs_vinculados = MdProcesoAdmin::obtenerPacsVinculados($id); // ← línea nueva

        require __DIR__ . '/../Vista/modulos/admin/actividades.php'; // ← sigue apuntando a actividades.php
    } catch (Throwable $e) {
